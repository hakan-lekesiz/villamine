    ...
    Actions: {
        ...
        show: function (arg) {
            ...
            if (arg.menu) {
                ...
                document.querySelector(".comp-header-01").classList.add("showw");
                Feux.Globals.overlayWrElem.classList.add("top");
            }
        ...
        closeClick: function (arg) {
            ...
            if (document.querySelector(".comp-header-01").classList.contains("showw")) {

                document.querySelector(".comp-header-01").classList.remove("showw");
                Feux.Globals.overlayWrElem.classList.remove("top");
            }
            var activityContainer = document.querySelector("#activity-container");
            if (document.querySelector(".search-wrapper")) {
                document.querySelector(".search-on").classList.remove("search-on");
                document.querySelector(".search-wrapper").classList.remove("search-wrapper");
            }
